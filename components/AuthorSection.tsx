...
export const AuthorSection: React.FC = () => {
  return (
    <section className="py-16 sm:py-20 md:py-24 px-4 md:px-8 relative flex justify-center" id="about">
      <div className="bg-[#fdfbf7] p-6 sm:p-8 md:p-12 max-w-2xl w-full colored-pencil-border shadow-[12px_12px_0px_0px_rgba(112,93,0,0.05)] rotate-0 sm:rotate-1 paper-edge relative">
        {/* Tape detail */}
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-28 sm:w-32 h-8 bg-surface-variant/50 rotate-[-2deg] shadow-sm rounded-sm pointer-events-none" />

        <div className="flex flex-col md:flex-row gap-6 sm:gap-8 items-center">
          <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full colored-pencil-border overflow-hidden flex-shrink-0 shadow-md">
            <img
          ...
          <div className="text-center md:text-left">
            <h2 className="font-headline-xl text-2xl sm:text-3xl md:text-4xl text-secondary mb-3 sm:mb-4 transform -rotate-1">
              Abhinav Mehrotra
            </h2>
            <p className="font-body-md text-on-surface-variant mb-4 sm:mb-6 leading-relaxed">
            ...
            <img
              ...
              className="h-8 sm:h-10 md:h-12 max-w-full opacity-80 mix-blend-multiply inline-block"
            />
          </div>
        </div>
      </div>
